...
let me = {
	...
	state: 'Utah',
	age: 25,
	greeter: function(name, state){'Hello! My name is ' + firstName + ' and I live in ' + state}
}
...
// Code Here
let doubled = myNumbers.map((nums) => {
	return nums * 2
})
...
// Code Here
let filtered = myNumbers.filter((nums) => {
	if(nums > 100){
		return nums
	}
})
